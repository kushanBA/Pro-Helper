...
class Architecturer extends StatefulWidget {
  const Architecturer({super.key});

  @override
  State<Architecturer> createState() => _ArchitecturerState();
}

final AuthServices _auth = AuthServices();

class _ArchitecturerState extends State<Architecturer> {
  final _userStream =
      FirebaseFirestore.instance.collection('Architecturer').snapshots();
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text("Architecturers"),
          actions: [
            // ElevatedButton(
            //     onPressed: () async {
            //       await _auth.signOut();
