...
class Electrician extends StatefulWidget {
  ...
  @override
  State<Electrician> createState() => _ArchitecturerState();
}

final AuthServices _auth = AuthServices();

class _ArchitecturerState extends State<Electrician> {
  final _userStream3 =
      FirebaseFirestore.instance.collection('Electrician').snapshots();
  @override
